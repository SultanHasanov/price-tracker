...
function getMainReplyKeyboard() {
  return {
    keyboard: [
      ["➕ Добавить отслеживание", "📋 Мои отслеживания"],
...
bot.on("message", async (msg) => {
  ...
  // Оригинальный код для обработки артикула
  if (userState && userState.state === STATES.WAITING_ARTICLE) {
